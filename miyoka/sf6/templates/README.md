## 重要: ストリートファイター6の著作権について

本テンプレート内の画像の著作権はカプコン株式会社（以下「カプコン」）に帰属し、**Miyoka が権利を有するものではありません**。あわせて、提供されている EULA（エンドユーザーライセンス契約）、利用規約、サービス規約も必ず確認してください。
